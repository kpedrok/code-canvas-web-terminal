"""
Main application module for the Web Terminal.
Contains the FastAPI application definition and all route configurations.
"""
...
def create_app() -> FastAPI:
    ...
    This function allows for better testing and separation of concerns.
    """
    app = FastAPI(title="Web Terminal API", version=APP_VERSION)
    ...
    global docker_client, user_sessions
    ...
    @app.get("/")
    def read_root():
        return {"message": "Web Terminal API is running", "version": APP_VERSION}
